    ...
    CommandLineRunner commandLineRunner(PostRepository postRepository, UserRepository userRepository, ReplyRepository replyRepository) {
        return args -> {
            ...
            User user = new User(1L,
                    ...
                    new ArrayList<Post>(),
                    new ArrayList<Reply>());;
            Content content2 = new Content("Binbo bagsi", "http://res.cloudinary.com/dc6h0nrwk/image/upload/v1664806729/uakzskirbbkgb30tejb0.gif", "http://res.cloudinary.com/dc6h0nrwk/video/upload/v1664806897/xzn8cw8bkvv3moc3d8ua.mp3");
